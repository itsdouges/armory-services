...
describe('gw2 api', function () {
  ...
  it('should return pvp stats', function (done) {
    sut.readPvpStats(testToken)
      .then(function (pvp) {
        expect(pvp.pvp_rank).toBeDefined();
        expect(pvp.pvp_rank_points).toBeDefined();
        expect(pvp.pvp_rank_rollovers).toBeDefined();
        expect(pvp.aggregate).toBeDefined();
        expect(pvp.professions).toBeDefined();
        expect(pvp.ladders).toBeDefined();
